...
print(type)
# 텍스트 파일로 저장 (탭 구분)
file_path = 'C:/code/python/autohunting/dataset_raw/test.txt'
...
# # 바이낸스에서 상장된 모든 심볼 가져오기
# markets = binance.load_markets()
# symbols = [market.replace('/', '') for market in markets if '/USDT' in market]  # 슬래시 제거 후 올바른 형식으로 변환
...
#     file_path = f'C:/code/python/autohunting/dataset_raw/{symbol}.txt'
